		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<!-- <form role="form" action="/board/register" method="post"> -->
					...
					<div class="form-group">
						<label>내용</label> 
						<textarea class="form-control" row="3" name="content" readonly="readonly"><c:out value="${board.content }"/>
						</textarea>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var operForm = $("#operForm"); /* 61행 <form id='operForm' action="/board/modify" method="get"> */
